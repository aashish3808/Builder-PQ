        ...
        <div class="form__fields-group">
            <div class="form-element col-1">
                ...
                <div style="position: relative;">
                    <input name="publication[name][]" col="col-2" type="text" label="Skill" maxlength="50" autocomplete="off" placeholder="e.g. Microsoft Word" class="" value="<?php echo @$current_record->name; ?>" />
            ...
            <div class="form-element col-1">
                ...
                <div style="position: relative;">
                    <textarea name="publication[description][]" class="tiny_editor"><?php echo @$current_record->description; ?></textarea>
                </div>
