    ...
    <div class="form__fields" style="display: block;">
        <div class="form__fields-group">
            <div class="form-element col-2">
                ...
                <div style="position: relative;">
                    <input name="education[degree][]" col="col-2" type="text" placeholder="e.g. Bachelor of Science" label="Degree" maxlength="100" class="" value="<?php echo @$current_record->degree;?>" />
            ...
            <div class="form-element col-2">
                ...
                <div style="position: relative;">
                    <input name="education[from_education][]" col="col-2" type="text" placeholder="e.g. San francisco" label="City/Town" maxlength="100" class="" value="<?php echo @$current_record->from_education;?>" />
        ...
        <div class="form__fields-group">
            <div class="form-element col-1">
                ...
                <div style="position: relative;">
                    <input name="education[school][]" col="col-1" type="text" placeholder="e.g. New York University" maxlength="100" class="" value="<?php echo @$current_record->school;?>" />
        ...
        <div class="form__fields-group col-2">
            <div class="form-element col-2">
                ...
                <select class="form-select-custom" name="education[start_month][]">
            ...
            <div class="form-element col-2">
                <label class="">&nbsp;</label>
                <select class="form-select-custom form__select-element" name="education[start_year][]">
                    <?php
        ...
        <div class="form__fields-group col-2">
            <div class="form-element col-2">
                ...
                <select class="form-select-custom" name="education[end_month][]">
            ...
            <div class="form-element col-2">
                <label class="">&nbsp;</label>
                <select class="form-select-custom form__select-element" name="education[end_year][]">
                    <?php
        ...
        <div class="form__fields-group">
            <div class="form-element col-1">
                ...
                <textarea name="education[description][]" class="tiny_editor"><?php echo @$current_record->description; ?></textarea>
            </div>
        </div>
