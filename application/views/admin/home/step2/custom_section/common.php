        ...
        <div class="form__fields-group">
            <div class="form-element col-1">
                ...
                <div style="position: relative;">
                    <input name="custom_section[heading][]" col="col-2" type="text"  class="" value="<?php echo @$current_record->heading; ?>" />
            ...
            <div class="form-element col-1">
                ...
                <div style="position: relative;">
                    <textarea name="custom_section[description][]" class="tiny_editor"><?php echo @$current_record->description; ?></textarea>
                </div>
